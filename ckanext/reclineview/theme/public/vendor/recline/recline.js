    ...
    <div class="recline-flot"> \
      <div class="panel graph" style="display: block;"> \
        <div class="js-temp-notice alert alert-warning alert-block"> \
          <p>' + ckan_translate._('Cannot plot a graph as no fields has been selected.') + '</p> \
          <p>' + ckan_translate._('Please, select fields using  <strong>the menu on the right</strong>') + '</p> \
        </div> \
      </div> \
    </div> \
',
    ...
    <form class="form-stacked"> \
      <div class="clearfix"> \
        <div class="form-group"> \
          <label>' + ckan_translate._('Graph Type') + '</label> \
          <div class="input editor-type"> \
            <select class="form-control"> \
              <option value="lines-and-points">' + ckan_translate._('Lines and Points') + '</option> \
              <option value="lines">' + ckan_translate._('Lines') + '</option> \
              <option value="points">' + ckan_translate._('Points') + '</option> \
              <option value="bars">' + ckan_translate._('Bars') + '</option> \
              <option value="columns">' + ckan_translate._('Columns') + '</option> \
            </select> \
          </div> \
        </div> \
        <div class="form-group"> \
          <label>' + ckan_translate._('Group Column (Axis 1)') + '</label> \
          <div class="input editor-group"> \
            <select class="form-control"> \
              <option value="">' + ckan_translate._('Please choose ...') + '</option> \
                {{#fields}} \
      ...
      <div class="editor-buttons"> \
        <button class="btn btn-default editor-add">' + ckan_translate._('Add Series') + '</button> \
      </div> \
      <div class="editor-buttons editor-submit" comment="hidden temporarily" style="display: none;"> \
        <button class="editor-save">' + ckan_translate._('Save') + '</button> \
...
',
  templateSeriesEditor: ' \
    <div class="editor-series js-series-{{seriesIndex}}"> \
      <div class="form-group"> \
        <label>' + ckan_translate._('Series') + ' <span>{{seriesName}} ' + ckan_translate._('(Axis 2)') + '</span> \
          [<a href="#remove" class="action-remove-series">' + ckan_translate._('Remove') + '</a>] \
        </label> \
        <div class="input"> \
          <select class="form-control"> \
          {{#fields}} \
    ...
    <div class="menu-container data-table-cell-editor"> \
      ...
      <div id="data-table-cell-editor-actions"> \
        <div class="data-table-cell-editor-action"> \
          <button class="okButton btn primary">' + ckan_translate._('Update') + '</button> \
          <button class="cancelButton btn danger">' + ckan_translate._('Cancel') + '</button> \
        </div> \
      </div> \
    </div> \
  ',
    ...
    _.every(docs, function(doc){
      ...
      if (typeof feature === 'undefined' || feature === null){
        ...
        try {
          ...
          wrongSoFar += 1;
          var msg = ckan_translate._('Wrong geometry value');
        ...
        wrongSoFar += 1;
        if (wrongSoFar <= 10) {
          self.trigger('recline:flash', {message: ckan_translate._('Wrong geometry value'), category:'error'});
        }
      }
      return true;
    });
...
my.MapMenu = Backbone.View.extend({
  ...
  template: ' \
    <form class="form-stacked"> \
      <div class="clearfix"> \
        <div class="editor-field-type"> \
            <label class="radio"> \
              ...
              ' + ckan_translate._('Latitude / Longitude fields') + '</label> \
            <label class="radio"> \
              <input type="radio" id="editor-field-type-geom" name="editor-field-type" value="geom" /> \
              ' + ckan_translate._('GeoJSON field') + '</label> \
        </div> \
        <div class="editor-field-type-latlon"> \
          <label>' + ckan_translate._('Latitude field') + '</label> \
          ...
          <label>' + ckan_translate._('Longitude field') + '</label> \
        ...
        <div class="editor-field-type-geom" style="display:none"> \
          <label>' + ckan_translate._('Geometry field (GeoJSON)') + '</label> \
      ...
      <div class="editor-buttons"> \
        <button class="btn btn-default editor-update-map">' + ckan_translate._('Update') + '</button> \
      </div> \
      <div class="editor-options" > \
        <label class="checkbox"> \
          <input type="checkbox" id="editor-auto-zoom" value="autozoom" checked="checked" /> \
          ' + ckan_translate._('Auto zoom to features') + '</label> \
        <label class="checkbox"> \
          <input type="checkbox" id="editor-cluster" value="cluster"/> \
          ' + ckan_translate._('Cluster markers') + '</label> \
      </div> \
...
my.MultiView = Backbone.View.extend({
  ...
  <div class="recline-data-explorer"> \
    ...
    <div class="header clearfix"> \
      ...
      <div class="recline-results-info"> \
        <span class="doc-count">{{recordCount}}</span> ' + ckan_translate._('records') + '\
      </div> \
  ...
  notify: function(flash) {
    var tmplData = _.extend({
      message: ckan_translate._('Loading'),
      category: 'warning',
      loader: false
      },
      flash
...
my.GridControl= Backbone.View.extend({
  ...
  template: '<h1><button href="#" class="recline-row-add btn btn-default">' + ckan_translate._('Add row') + '</button></h1>',
...
my.FilterEditor = Backbone.View.extend({
  ...
  template: ' \
    <div class="filters"> \
      <h3>Filters</h3> \
      <a href="#" class="js-add-filter">' + ckan_translate._('Add filter') + '</a> \
      <form class="form-stacked js-add" style="display: none;"> \
        <div class="form-group"> \
          <label>' + ckan_translate._('Field') + '</label> \
        ...
        <div class="form-group"> \
          <label>' + ckan_translate._('Filter type') + '</label> \
          <select class="filterType form-control"> \
            <option value="term">' + ckan_translate._('Value') + '</option> \
            <option value="range">' + ckan_translate._('Range') + '</option> \
            <option value="geo_distance">' + ckan_translate._('Geo distance') + '</option> \
          </select> \
        </div> \
        <button type="submit" class="btn btn-default">' + ckan_translate._('Add') + '</button> \
      </form> \
      <form class="form-stacked js-edit"> \
        ...
        {{/filters}} \
        {{#filters.length}} \
        <button type="submit" class="btn btn-default">' + ckan_translate._('Update') + '</button> \
        {{/filters.length}} \
      </form> \
    </div> \
  ',
      ...
      <div class="filter-{{type}} filter"> \
        <fieldset> \
          <legend> \
            ...
            <a class="js-remove-filter" href="#" title="' + ckan_translate._('Remove this filter') + '" data-filter-id="{{id}}">&times;</a> \
          </legend> \
...
my.ValueFilter = Backbone.View.extend({
  ...
  template: ' \
    <div class="filters"> \
      <h3>Filters</h3> \
      <button class="btn js-add-filter add-filter">' + ckan_translate._('Add filter') + '</button> \
      <form class="form-stacked js-add" style="display: none;"> \
        <fieldset> \
          <label>Field</label> \
          <select class="fields form-control"> \
          ...
          <button type="submit" class="btn">' + ckan_translate._('Add') + '</button> \
        </fieldset> \
      </form> \
      <form class="form-stacked js-edit"> \
        {{#filters}} \
        ...
        {{/filters}} \
        {{#filters.length}} \
        <button type="submit" class="btn update-filter">' + ckan_translate._('Update') + '</button> \
        {{/filters.length}} \
      </form> \
    </div> \
  ',
